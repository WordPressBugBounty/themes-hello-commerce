...
class Notificator {
	...
	public function __construct() {
		...
		$this->notificator = new \Elementor\WPNotificationsPackage\V120\Notifications( [
			'app_name' => 'hello-commerce',
			'app_version' => HELLO_COMMERCE_ELEMENTOR_VERSION,
			'short_app_name' => 'ehcommerce',
			'app_data' => [
	...
	private function ensure_notifications_class_loaded(): bool {
		...
		$hello_commerce_autoload = HELLO_COMMERCE_PATH . '/vendor/autoload.php';
		if ( file_exists( $hello_commerce_autoload ) ) {
			require_once $hello_commerce_autoload;
		}
